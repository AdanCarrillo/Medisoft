<?php 
	...
	$id_usaurio =$_SESSION['id'];

	$where = "WHERE Id_medico = '$id_usaurio'";
	...
	<div class="container">
    	...
    	<div class="row">
    		<div class="col-12 col-sm-12  col-md-12 col-lg-6  col-xl-6 columnaInfo"> 
				<a href="GenerarConsulta.php" class="btn btn-info">Nueva Consulta</a>
				<p></p>
			</div>
			<div class="col-12 col-sm-12  col-md-12 col-lg-6  col-xl-6 columnaInfo"> 
				<a href="BorrarHistorialConsultas.php" id="Elimin">BorrarHisorial</a>
				<p></p>
       	 	</div>
		</div>
    	...
    	<div class="row">
			...
			<form action="<?php $_SERVER['PHP_SELF']; ?>" method="POST">
					<b>Folio: </b><input type="text" id="campo" name="campo" />
				...
				<table class="table table-striped">
					...
					<?php while($row = $resultado->fetch_array(MYSQLI_ASSOC)) { ?>
							<tr>
								...
								<td><a href="ModificarConsultas.php?Folio=<?php echo $row['Folio'];?>" id="Modifi">Modficar</a></td>
								<td><a href="#" data-href="EliminarConsultaPMedico.php?Folio=<?php echo $row['Folio'];?>" data-toggle="modal" data-target="#confirm-delete" id="Elimin">Eliminar</a></td>
							</tr>
						<?php } ?>
					</tbody>
				</table>
