<?php 
	...
	if(!empty($_POST))
	{
		$valor = $_POST['campo'];
		if(!empty($valor)){
			$where = "WHERE Nombre_generico LIKE '%$valor' OR Id_medicamento LIKE '%$valor'";
		}
	}
	...
	<div class="container">
    	...
    	<div class="row">
    		<div class="col-12 col-sm-12  col-md-12 col-lg-12  col-xl-12 columnaInfo"> 
				<a href="AgregarMedicamentos.php" class="btn btn-info">Nuevo Medicamento</a>
				<p></p>
       	 	</div>
		</div>
				...
				<table class="table table-striped">
					...
					<?php while($row = $resultado->fetch_array(MYSQLI_ASSOC)) { ?>
							<tr>
								...
								<td><?php echo $row['Via_admin']; ?></td>
								<td><?php echo $row['Lote']; ?></td>
								<td><?php echo $row['Stock']; ?></td>
								<td><?php echo $row['Precio_publico']; ?></td>
								<td><a href="ModificarMedicamentos.php?Id_medicamento=<?php echo $row['Id_medicamento'];?>" id="Modifi">Modficar</a></td>
								<td><a href="#" data-href="EliminarMedicamento.php?Id_medicamento=<?php echo $row['Id_medicamento'];?>" data-toggle="modal" data-target="#confirm-delete" id="Elimin">Eliminar</a></td>
							</tr>
						<?php } ?>
					</tbody>
				</table>
