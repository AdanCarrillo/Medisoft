...
<body>
	...
	<div class="container">
		<form action="GuardaAuxiliar.php" method="POST" enctype="multipart/form-data" class="formAgregar">
			<div class="row">
				<div class="col-12 col-sm-12  col-md-6 col-lg-4  col-xl-4 columnaInfo">
					<div class="formGroup">
						...
						<input type="text" maxlength="5" class="control-form" id="Id_empleado" name="Id_empleado"
				...
				<div class="col-12 col-sm-12  col-md-6 col-lg-4  col-xl-4 columnaInfo">
					<div class="formGroup">
						...
						<input type="text" maxlength="16" class="control-form" id="CURP" name="CURP" placeholder="CURP"
							required>
					</div>
				</div>
			...
			<div class="row">
				...
				<div class="col-12 col-sm-12  col-md-6 col-lg-4  col-xl-4 columnaInfo">
					<div class="formGroup">
						...
						<input type="text" class="control-form" id="aPaterno" name="Apellido_paterno"
				...
				<div class="col-12 col-sm-12  col-md-12 col-lg-4  col-xl-4 columnaInfo">
					<div class="formGroup">
						...
						<input type="text" class="control-form" id="aMaterno" name="Apellido_materno"
			...
			<div class="row">
				<div class="col-12 col-sm-12  col-md-6 col-lg-4  col-xl-4 columnaInfo">
					<div class="formGroup">
						...
						<input type="text" maxlength="10" class="control-form" id="telfono" name="Telefono"
				...
				<div class="col-12 col-sm-12  col-md-6 col-lg-4  col-xl-4 columnaInfo">
					<div class="formGroup">
						...
						<input type="date" class="control-form" id="fecha" name="Fecha_nacimiento"
				...
				<div class="col-12 col-sm-12  col-md-12 col-lg-4  col-xl-4 columnaInfo">
					<div class="formGroup">
						...
						<input type="text" class="control-form" id="direccion" name="Direccion" placeholder="Dirección"
							required>
					</div>
				</div>
			</div>
			<div class="row">
				...
				<div class="col-12 col-sm-12  col-md-6 col-lg-8  col-xl-8 columnaInfo">
					<div class="formGroup">
						...
						<input type="password" class="control-form" id="contrasena" name="Contrasenia"
			...
			<div class="row">
				<div class="col-12 col-sm-12  col-md-6 col-lg-4  col-xl-4 columnaInfo">
					<div class="formGroup">
						<button type="submit" id="btnGuardar" class="botones botonDefecto">Guardar</button>
					</div>
				</div>
