<?php 
	...
	$sql = "UPDATE usuarios SET CURP='$curp', Nombre='$nombre', Apellido_paterno='$aPaterno', 
			Apellido_materno='$aMaterno', Telefono='$telefono', Fecha_nacimiento='$fechaNac', 
			Direccion='$direccion', Email='$email', Contrasenia='$contrasena' 
			WHERE Id_empleado ='$idempleado'";

	$sql1 = "UPDATE medicos SET CEDULA='$Cedula', Especialidad='$Especialidad', Fac_egreso='$Facultad' WHERE Id_medico ='$idempleado'";
