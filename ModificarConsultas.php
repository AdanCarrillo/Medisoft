			...
			<div class="row">
				...
				<div class="col-12 col-sm-12  col-md-6 col-lg-4  col-xl-4 columnaInfo"> 
    				<div class="formGroup">
    	      			...
    	      			<input type="date" class="control-form" id="fechacons" name="Fecha_consulta" value="<?php echo $row['Fecha_consulta'];?>" required>
    				</div>
        		</div>
        		...
        		<div class="col-12 col-sm-12  col-md-12 col-lg-4  col-xl-4 columnaInfo"> 
    				<div class="formGroup">
    	      			...
    	      			<input type="text" class="control-form" id="pacient" name="Paciente" value="<?php echo $row['Paciente'];?>" required>
    				</div>
        		</div>
			</div>
			<div class="row">
    			<div class="col-12 col-sm-12  col-md-6 col-lg-4  col-xl-4 columnaInfo"> 
    				<div class="formGroup">
    	      			...
    	      			<input type="text" class="control-form" id="edad" name="Edad" value="<?php echo $row['Edad'];?>" required>
    				</div>
        		</div>
				...
				<div class="col-12 col-sm-12  col-md-6 col-lg-4  col-xl-4 columnaInfo"> 
    				<div class="formGroup">
    	      			...
    	      			<input type="text" class="control-form" id="estatura" name="Estatura" value="<?php echo $row['Estatura'];?>" required>
    				</div>
        		</div>
        		...
        		<div class="col-12 col-sm-12  col-md-12 col-lg-4  col-xl-4 columnaInfo"> 
    				<div class="formGroup">
    	      			...
    	      			<input type="text" class="control-form" id="peso" name="Peso" value="<?php echo $row['Peso'];?>" required>
    				</div>
        		</div>
			</div>
			<div class="row">
    			<div class="col-12 col-sm-12  col-md-6 col-lg-4  col-xl-4 columnaInfo"> 
    				<div class="formGroup">
    	      			...
    	      			<input type="text" class="control-form" id="temp" name="Temperatura" value="<?php echo $row['Temperatura'];?>" required>
    				</div>
        		</div>
        		...
        		<div class="col-12 col-sm-12  col-md-6 col-lg-4  col-xl-4 columnaInfo"> 
    				<div class="formGroup">
    	      			...
    	      			<input type="text" class="control-form" id="preio" name="Presion" value="<?php echo $row['Presion'];?>" required>
    				</div>
        		</div>
        		...
        		<div class="col-12 col-sm-12  col-md-12 col-lg-4  col-xl-4 columnaInfo"> 
    				<div class="formGroup">
    	      			...
    	      			<input type="text" class="control-form" id="alergs" name="Alergias" value="<?php echo $row['Alergias'];?>" required>
    				</div>
        		</div>
			</div>
			<div class="row">
				<div class="col-12 col-sm-12  col-md-12 col-lg-4  col-xl-12 columnaInfo"> 
    				<div class="formGroup">
   	    				...
   	    				<p></p>
    	      			<textarea name="Padecimiento" rows="10" cols="50" required><?php echo $row['Padecimiento'];?></textarea>
    				</div>
        		</div>
        		...
        		<div class="col-12 col-sm-12  col-md-12 col-lg-4  col-xl-12 columnaInfo"> 
    				<div class="formGroup">
   	    				...
   	    				<p></p>
   	    				<textarea name="Medicacion" id="" cols="50" rows="10"  required><?php echo $row['Medicacion'];?></textarea>
    				</div>
        		</div>
			</div>
			<div class="row">
    			...
    			<div class="col-12 col-sm-12  col-md-6 col-lg-8  col-xl-8 columnaInfo"> 
    				<div class="formGroup">
   	    				<input type="submit" id="btnCancelar" class="botones botonDefecto" value="Cancelar">
    				</div>
        		</div>
			</div>
