...
CREATE TABLE MEDICAMENTOS(Id_medicamento INT,
						  ...
						  Stock VARCHAR(15),
						  Precio_fabricante FLOAT DEFAULT 0,
...
CREATE TABLE VENTA(Folio INT AUTO_INCREMENT,
				   ...
				   FOREIGN KEY (Folio_medicamento) REFERENCES MEDICAMENTOS(Id_medicamento)
				   );
...
INSERT INTO MEDICAMENTOS(Id_medicamento, Nombre_generico, Nombre_comercial, Contenido, Via_admin, Recipiente, Laboratorio, Caducidad, lote, Stock, Precio_fabricante, Precio_publico) 
VALUES(384764, "Paracetamol", "Acertar", "6 Tabletas", "Oral", "caja", "Farmacon", "2022-12-12", "AE-35", "AG", 20.0, 30.0);
INSERT INTO MEDICAMENTOS(Id_medicamento, Nombre_generico, Nombre_comercial, Contenido, Via_admin, Recipiente, Laboratorio, Caducidad, lote, Stock, Precio_fabricante, Precio_publico)
VALUES(465312, "Omeprazol", "Arapride", "Tableta 12mg", "Oral", "100 Capsulas", "AstraZeneca", "2023-12-20", "AE-35", "AE", 45.00, 60.00);
INSERT INTO MEDICAMENTOS(Id_medicamento, Nombre_generico, Nombre_comercial, Contenido, Via_admin, Recipiente, Laboratorio, Caducidad, lote, Stock, Precio_fabricante, Precio_publico)
VALUES(735345, "Ambroxol", "Ambroxol", "Solucion 7.5 mg/ml", "Oral", "Frasco 30m ml", "Farmacon", "2222-06-22", "AE-35", "RG", 55.45, 70.00);
INSERT INTO MEDICAMENTOS(Id_medicamento, Nombre_generico, Nombre_comercial, Contenido, Via_admin, Recipiente, Laboratorio, Caducidad, lote, Stock, Precio_fabricante, Precio_publico)
VALUES(938463, "Naproxeno", "Naxodol", "Capsulas 250 mg ", "Oral", "caja 30 tabletas", "Seigfred", "2024-10-12", "AE-37", "AR", 25.50, 35.00);
INSERT INTO MEDICAMENTOS(Id_medicamento, Nombre_generico, Nombre_comercial, Contenido, Via_admin, Recipiente, Laboratorio, Caducidad, lote, Stock, Precio_fabricante, Precio_publico)
VALUES(937422, "Hidrocortisona", "Acertar", "Crema", "Topica", "Tubo 60 ml", "Galderma", "2023-02-14", "RE-35", "UT", 75.00, 92.75);