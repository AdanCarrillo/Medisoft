<?php 
	...
	if(!empty($_POST))
	{
		$valor = $_POST['campo'];
		if(!empty($valor)){
			$where = "WHERE Folio LIKE '%$valor' OR Paciente LIKE '%$valor'";
		}
	}
				...
				<table class="table table-striped">
					...
					<?php while($row = $resultado->fetch_array(MYSQLI_ASSOC)) { ?>
							<tr>
								...
								<td><a href="VisualizacionConsultas.php?Folio=<?php echo $row['Folio'];?>" id="Modifi">Visualizar</a></td>
								<td><a href="#" data-href="EliminarConsulta.php?Folio=<?php echo $row['Folio'];?>" data-toggle="modal" data-target="#confirm-delete" id="Elimin">Eliminar</a></td>
							</tr>
						<?php } ?>
					</tbody>
				</table>
