<?php 
	...
	$sql = "INSERT INTO usuarios (Id_empleado, CURP, Sexo, Nombre, Apellido_paterno, Apellido_materno, Telefono, Fecha_nacimiento, Direccion, Email, Contrasenia, Id_rol) 
			VALUES ('$idempleado', '$curp', '$sexo', '$nombre', '$aPaterno', '$aMaterno', '$telefono', '$fechaNac', '$direccion', '$email', '$contrasena', '3')";
		...
		<div class="container">
			<div class="row">
				<div class="row" style="text-align:center">
					...
					<a href="AgregarAuxiliares.html" class="btn btn-primary">Regresar</a>
