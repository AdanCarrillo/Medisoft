<?php 
	...
	if(!empty($_POST))
	{
		$valor = $_POST['campo'];
		if(!empty($valor)){
			$where = "WHERE (Id_empleado LIKE '%$valor') AND (Id_rol=2)";
		}
	}
	...
	<div class="container">
    	...
    	<div class="row">
    		<div class="col-12 col-sm-12  col-md-12 col-lg-12  col-xl-12 columnaInfo"> 
				<a href="AgregarMedicos.php" class="btn btn-info">Nuevo Medico</a>
				<p></p>
       	 	</div>
		</div>
    	...
    	<div class="row">
			...
			<form action="<?php $_SERVER['PHP_SELF']; ?>" method="POST">
					<b>ID Medico: </b><input type="text" id="campo" name="campo" />
				...
				<table class="table table-striped">
					...
					<?php while($row = $resultado->fetch_array(MYSQLI_ASSOC)) { ?>
							<tr>
								...
								<td><a href="ModificarMedicos.php?Id_empleado=<?php echo $row['Id_empleado']; ?>" id="Modifi">Modficar</a></td>
								<td><a href="#" data-href="EliminarMedico.php?Id_empleado=<?php echo $row['Id_empleado']; ?>" data-toggle="modal" data-target="#confirm-delete" id="Elimin">Eliminar</a></td>
							</tr>
						<?php } ?>
					</tbody>
				</table>
