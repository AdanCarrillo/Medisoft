<?php
	...
	$sql1 = "SELECT * FROM medicos WHERE Id_medico = '$id'";
...
<body>
    ...
    <div class="container">
   		<form action="ModificarMedico.php" method="POST" enctype="multipart/form-data" class="formAgregar">
    		<div class="row">
    			<div class="col-12 col-sm-12  col-md-6 col-lg-4  col-xl-4 columnaInfo"> 
    				<div class="formGroup">
    	      			...
    	      			<input type="text" maxlength="5" class="control-form" id="Id_empleado" readonly name="Id_empleado" placeholder="Id Medico" value="<?php echo $row['Id_empleado'];?>" required>  
    				</div>
        		</div>
			...
			<div class="row">
				<div class="col-12 col-sm-12  col-md-6 col-lg-4  col-xl-4 columnaInfo"> 
    				<div class="formGroup">
    	      			...
    	      			<input type="text" class="control-form" id="cedula" name="Cedula" placeholder="Cedula" maxlength="8" value="<?php echo $row1['Cedula'];?>" required>
    				</div>
        		</div>
    			...
    			<div class="col-12 col-sm-12  col-md-6 col-lg-4  col-xl-4 columnaInfo"> 
    				<div class="formGroup">
    	      			...
    	      			<input type="text" class="control-form" id="especialidad" name="Especialidad" placeholder="Especialidad" value="<?php echo $row1['Especialidad'];?>" required>
    				</div>
        		</div>
				...
				<div class="col-12 col-sm-12  col-md-12 col-lg-4  col-xl-4 columnaInfo"> 
    				<div class="formGroup">
    	      			...
    	      			<input type="text" class="control-form" id="facultad" name="Fac_egreso" placeholder="Facultad" value="<?php echo $row1['Fac_egreso'];?>" required>
    				</div>
        		</div>
			</div>
			<div class="row">
