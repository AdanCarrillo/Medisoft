<?php 
	...
	$sql = "INSERT INTO medicamentos (Id_medicamento, Nombre_generico, Nombre_comercial, Contenido, Via_admin, Recipiente, Laboratorio, Caducidad, Lote, Stock, Precio_fabricante, Precio_publico) 
			VALUES ('$Folio', '$NombreGenerico', '$NombreComercial', '$Contenido', '$Via', '$Recipiente', '$Laboratorio', '$Caducidad', '$Lote', '$Stock','$precioFab','$precioPub')";
